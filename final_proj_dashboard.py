...
sns.boxplot(data=artists, 
                         x='sex', y='listeners',palette='deep')
plt.ylabel('Listeners (millions)')
plt.subplot(1,2,2)
sns.boxplot(data=artists, x='sex', y = 'playcount',palette='deep')
plt.ylabel('Play count (billions)')
st.pyplot(fig)
...
sns.barplot(data=top_10_genres, x='index', y='count',palette='deep')
...
plt.subplot(1,2,1)
sns.boxplot(data=top_10_full, x='main_genre', y='listeners',palette='deep')
plt.ylabel('listeners (millions)')
plt.xticks(rotation=45, ha="right")
plt.subplot(1,2,2)
sns.boxplot(data=top_10_full, x='main_genre', y='playcount',palette='deep')
plt.ylabel('Play count (billions)')
plt.xticks(rotation=45, ha="right")
st.pyplot(fig)
